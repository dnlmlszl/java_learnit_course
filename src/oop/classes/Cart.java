...
public class Cart {
	...
	public void addProduct(Product product) {
		...
		if (products == null) products = new Product[DEFAULT_CART_CAPACITY];
		
		if (products.length < indexToAddNewProduct + 1) products = Arrays.copyOf(products, products.length << 1);
